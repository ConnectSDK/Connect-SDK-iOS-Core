//
//  CNTZeroConfDiscoveryProvider.m
//  Connect SDK
//
...
@interface CNTZeroConfDiscoveryProvider ()
{
...
@implementation CNTZeroConfDiscoveryProvider
...
- (void)addDeviceFilter:(NSDictionary *)parameters
{
    ...
    _CNT_assert_state(ssdpInfo != nil, @"This device filter does not have zeroconf discovery info");
...
- (void)netServiceBrowser:(NSNetServiceBrowser *)aNetServiceBrowser didRemoveService:(NSNetService *)aNetService moreComing:(BOOL)moreComing
{
    ...
    CNTServiceDescription *serviceDescription = _discoveredDevices[aNetService.name];
...
- (void) netServiceDidResolveAddress:(NSNetService *)sender
{
    ...
    CNTServiceDescription *serviceDescription = [CNTServiceDescription descriptionWithAddress:address UUID:sender.name];
