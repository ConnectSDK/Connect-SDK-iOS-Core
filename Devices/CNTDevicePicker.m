...
@implementation CNTDevicePicker
{
...
- (void)setCurrentDevice:(CNTConnectableDevice *)currentDevice
{
...
- (void) showPicker:(id)sender
{
    ...
    _showServiceLabel = [CNTDiscoveryManager sharedManager].capabilityFilters.count == 0;
...
- (void) showActionSheet:(id)sender
{
    ...
    [_actionSheetDeviceList enumerateObjectsUsingBlock:^(CNTConnectableDevice *device, NSUInteger idx, BOOL *stop)
    {
...
- (void) sortDevices
{
    dispatch_async(_sortQueue, ^{
        ...
        @synchronized (_generatedDeviceList)
        {
            _generatedDeviceList = [devices sortedArrayUsingComparator:^NSComparisonResult(CNTConnectableDevice *device1, CNTConnectableDevice *device2) {
...
- (NSString *) nameForDevice:(CNTConnectableDevice *)device
{
    NSString *name;
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    CNTConnectableDevice *device = [_actionSheetDeviceList objectAtIndex:buttonIndex];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    @synchronized (_generatedDeviceList)
    {
        device = (CNTConnectableDevice *) [_generatedDeviceList objectAtIndex:indexPath.row];
    }
