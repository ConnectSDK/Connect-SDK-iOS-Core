...
@protocol CNTDeviceServiceReachabilityDelegate;

@interface CNTDeviceServiceReachability : NSObject
...
@property (nonatomic) id<CNTDeviceServiceReachabilityDelegate> delegate;
