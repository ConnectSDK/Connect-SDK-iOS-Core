...
@class CNTSSDPSocketListener;

@protocol CNTSocketListenerDelegate <NSObject>

@optional

- (void)socket:(CNTSSDPSocketListener *)aSocket didReceiveData:(NSData *)aData fromAddress:(NSString *)anAddress;
- (void)socket:(CNTSSDPSocketListener *)aSocket didEncounterError:(NSError *)anError;

@end

@interface CNTSSDPSocketListener : NSObject

@property (nonatomic, assign) id<CNTSocketListenerDelegate> delegate;
