...
/*!
 * Normalized reference object for information about a CNTDeviceService's app. This object will, in most cases, be used to launch apps.
 *
...
/*!
 * Compares two CNTAppInfo objects.
 *
 * @param appInfo CNTAppInfo object to compare.
 *
 * @return YES if both CNTAppInfo id values are equal
 */
- (BOOL)isEqual:(CNTAppInfo *)appInfo;
 ...
 */
+ (CNTAppInfo *) appInfoForId:(NSString *)appId;
