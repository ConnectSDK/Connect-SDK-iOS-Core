	...
	dispatch_source_set_event_handler(self->_dispatchSource,
		^{
			...
			if (theLastReceiveBytesCount > 0)
			{
				...
				NSData * theReceivedData = [NSData dataWithBytes:theBuffer length:theLastReceiveBytesCount];
