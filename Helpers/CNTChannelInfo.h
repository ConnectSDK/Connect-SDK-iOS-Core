 ...
 */
@interface CNTChannelInfo : NSObject
...
/*!
 * Compares two CNTChannelInfo objects.
 *
 * @param channelInfo CNTChannelInfo object to compare.
 *
 * @return YES if both CNTChannelInfo number & name values are equal
 */
- (BOOL)isEqual:(CNTChannelInfo *)channelInfo;
