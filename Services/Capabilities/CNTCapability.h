...
/*!
 * CapabilityPriorityLevel values are used by CNTConnectableDevice to find the most suitable CNTDeviceService capability to be presented to the user. Values of VeryLow and VeryHigh are not in use internally the SDK. Connect SDK uses Low, Normal, and High internally.
 *
 * Default behavior:
