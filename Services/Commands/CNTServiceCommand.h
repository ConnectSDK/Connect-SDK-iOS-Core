...
- (instancetype) initWithDelegate:(id <CNTServiceCommandDelegate>)delegate target:(NSURL *)url payload:(id)payload;
+ (instancetype) commandWithDelegate:(id <CNTServiceCommandDelegate>)delegate target:(NSURL *)url payload:(id)payload;
