...
@implementation CNTServiceConfig
{
    BOOL _hasObservers;
}
...
+ (instancetype) serviceConfigWithJSONObject:(NSDictionary *)dictionary
{
    ...
    CNTServiceConfig *serviceConfig = [[configClass alloc] initWithJSONObject:dictionary];
...
- (instancetype) initWithServiceDescription:(CNTServiceDescription *)serviceDescription
{
    self = [super init];
...
- (void)setDelegate:(id <CNTServiceConfigDelegate>)delegate
{
