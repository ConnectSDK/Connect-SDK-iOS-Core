//
//  CNTAirPlayServiceHTTPKeepAlive.m
//  ConnectSDK
//
...
@interface CNTAirPlayServiceHTTPKeepAlive ()
...
@implementation CNTAirPlayServiceHTTPKeepAlive

#pragma mark - Init

- (instancetype)initWithInterval:(CGFloat)interval
              andCommandDelegate:(id<CNTServiceCommandDelegate>)commandDelegate {
    if (self = [super init]) {
        _interval = interval;
...
- (instancetype)initWithCommandDelegate:(id<CNTServiceCommandDelegate>)commandDelegate {
...
- (void)sendKeepAlive:(NSTimer *)timer {
    ...
    CNTServiceCommand *keepAliveCommand = [CNTServiceCommand commandWithDelegate:self.commandDelegate
                                                                          target:keepAliveURL
                                                                         payload:nil];
