//
//  CNTZeroConfDiscoveryProviderTests.m
//  ConnectSDK
//
...
/// Tests for the CNTZeroConfDiscoveryProvider class.
...
@interface CNTZeroConfDiscoveryProviderTests : XCTestCase

@property (nonatomic, strong) CNTZeroConfDiscoveryProvider *provider;

@end

@implementation CNTZeroConfDiscoveryProviderTests
...
- (void)setUp {
    ...
    self.provider = [CNTZeroConfDiscoveryProvider new];
}
...
/// addresses, and provided in the @c CNTServiceDescription.
- (void)testShouldCallDelegateWithIPv4AndNotIPv6Address {
    ...
    id delegateMock = OCMProtocolMock(@protocol(CNTDiscoveryProviderDelegate));
    OCMExpect([delegateMock discoveryProvider:self.provider
                               didFindService:[OCMArg checkWithBlock:^BOOL(CNTServiceDescription *description) {
