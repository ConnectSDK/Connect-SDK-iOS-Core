//
//  NSDictionary+CNTKeyPredicateSearchTests.m
//  ConnectSDK
//
...
/// Tests for the @c NSDictionary+CNTKeyPredicateSearch category.
@interface NSDictionary_CNTKeyPredicateSearchTests : XCTestCase

@property (nonatomic, strong) NSDictionary *sampleDict;

@end

@implementation NSDictionary_CNTKeyPredicateSearchTests
