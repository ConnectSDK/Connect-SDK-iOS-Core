...
#import "CNTDLNAHTTPServer_Private.h"
#import "GCDWebServerDataRequest.h"

@interface CNTEventInfo : NSObject
...
/// Tests for the @c CNTDLNAHTTPServer class.
@interface CNTDLNAHTTPServerTests : XCTestCase

@end

@implementation CNTDLNAHTTPServerTests
...
- (void)testRenderingControlNotificationShouldTriggerRenderingControlSubscriptionOnly_Sonos {
    CNTEventInfo *const kRenderingControlEventInfo = [[CNTEventInfo alloc] initWithURL:@"/MediaRenderer/RenderingControl/Event"
                                                                            path:@"/MediaRenderer/RenderingControl/Event"
                                                                        andQuery:@{}];
    CNTEventInfo *const kAVTransportEventInfo = [[CNTEventInfo alloc] initWithURL:@"/MediaRenderer/AVTransport/Event"
...
- (void)testRenderingControlNotificationShouldTriggerRenderingControlSubscriptionOnly_Xbox {
    CNTEventInfo *const kRenderingControlEventInfo = [[CNTEventInfo alloc] initWithURL:@"/upnphost/udhisapi.dll?event=uuid:0f4810a6-4fb4-4fdf-8acc-81e751e7ec8a+urn:upnp-org:serviceId:RenderingControl"
    ...
    CNTEventInfo *const kAVTransportEventInfo = [[CNTEventInfo alloc] initWithURL:@"/upnphost/udhisapi.dll?event=uuid:0f4810a6-4fb4-4fdf-8acc-81e751e7ec8a+urn:upnp-org:serviceId:AVTransport"
                                                                            path:@"/upnphost/udhisapi.dll"
...
- (void)checkRenderingControlNotificationShouldTriggerRenderingControlSubscriptionOnlyWithRenderingControlEventInfo:(CNTEventInfo *)renderingControlEventInfo
                                                                                            andAVTransportEventInfo:(CNTEventInfo *)avTransportEventInfo {
    // Arrange
    CNTDLNAHTTPServer *server = [CNTDLNAHTTPServer new];
    ...
    CNTServiceSubscription *renderingControlSubscription = [[CNTServiceSubscription alloc] initWithDelegate:nil
    ...
    CNTServiceSubscription *avTransportSubscription = [[CNTServiceSubscription alloc] initWithDelegate:nil
