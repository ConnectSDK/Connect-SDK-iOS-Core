//
//  CNTAirPlayServiceHTTPKeepAliveTests.m
//  ConnectSDK
//
...
/// Tests for the @c CNTAirPlayServiceHTTPKeepAlive class.
@interface CNTAirPlayServiceHTTPKeepAliveTests : XCTestCase
...
@implementation CNTAirPlayServiceHTTPKeepAliveTests
...
- (void)setUp {
    ...
    self.commandDelegateMock = OCMProtocolMock(@protocol(CNTServiceCommandDelegate));
    self.keepAlive = [[CNTAirPlayServiceHTTPKeepAlive alloc] initWithInterval:kDefaultKeepAliveInterval
...
- (void)testCreatedKeepAliveShouldNotBeStarted {
    ...
    [[self.commandDelegateMock reject] sendCommand:OCMOCK_ANY
                                       withPayload:OCMOCK_ANY
                                             toURL:OCMOCK_ANY];
    CNTAirPlayServiceHTTPKeepAlive *keepAlive = [[CNTAirPlayServiceHTTPKeepAlive alloc] initWithInterval:kDefaultKeepAliveInterval
                                                                                andCommandDelegate:self.commandDelegateMock];
...
- (void)testStopTimerShouldStopSendingRequests {
    // Arrange
    id commandDelegateMock2 = OCMProtocolMock(@protocol(CNTServiceCommandDelegate));
