//
//  CNTWebOSTVServiceSocketClientTests.m
//  ConnectSDK
//
...
#import "CNTWebOSTVServiceSocketClient_Private.h"

/// Tests for the @c CNTWebOSTVServiceSocketClient class.
@interface CNTWebOSTVServiceSocketClientTests : XCTestCase

@end

@implementation CNTWebOSTVServiceSocketClientTests
...
- (void)testDeniedPairingShouldCallRegistrationFailed {
    ...
    CNTWebOSTVServiceSocketClient *socketClient = OCMPartialMock([[CNTWebOSTVServiceSocketClient alloc] initWithService:serviceMock]);
