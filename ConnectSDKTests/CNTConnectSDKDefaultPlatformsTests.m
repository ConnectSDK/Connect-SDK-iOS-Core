//
//  CNTConnectSDKDefaultPlatformsTests.m
//  CNTConnectSDKDefaultPlatformsTests
//
...
@interface CNTConnectSDKDefaultPlatformsTests : XCTestCase

@end

@implementation CNTConnectSDKDefaultPlatformsTests

/// Tests that the default platforms list is defined and not empty.
- (void)testThereShouldBeDefaultPlatforms {
    NSDictionary *platforms = kCNTConnectSDKDefaultPlatforms;
